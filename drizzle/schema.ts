...
export const tailoredResumeVersions = mysqlTable("tailoredResumeVersions", {
  ...
  applicationStatus: mysqlEnum("applicationStatus", ["draft", "ready", "applied", "screening", "interview", "offer", "rejected", "withdrawn"]).default("draft").notNull(),
  applicationPlatform: varchar("applicationPlatform", { length: 80 }),
